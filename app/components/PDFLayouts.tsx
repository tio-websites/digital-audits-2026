  ...
  return (
    ...
    >
      <span style={{ color: BLUE, fontSize: 9, letterSpacing: 0.3 }}>
        the invisible orthodontist - Digital Audit Report&nbsp;&nbsp;Internal
        use only
      </span>
    </div>
  );
...
/**
 * One self-contained A4 page: header at top, content in middle, footer at
 * bottom. Each page is its own flex column, so the footer is always at the
 * bottom of the physical page. `last` omits the break-after to avoid a
 * blank trailing page.
 */
function PdfPage({
  subtitle,
  ...
  return (
    <div className={last ? "pdf-page-last" : "pdf-page"}>
      <PdfHeader subtitle={subtitle} />
      <div style={{ flex: 1, padding: "16px 40px" }}>{children}</div>
      <PdfFooter />
    </div>
  );
}
...
export function FullReportLayout({ result }: Props) {
  ...
  return (
    <div style={{ fontFamily: "Inter, Arial, sans-serif" }}>
      ...
      <PdfPage subtitle="Digital Audit Report">
        <div
          style={{
            display: "flex",
            gap: 28,
      ...
      {CATEGORIES.map((cat) => {
        ...
        const c = scoreColour(s);
        return (
          <PdfPage key={cat.key} subtitle={cat.title}>
            <div
              style={{
                display: "flex",
                alignItems: "flex-end",
      ...
      <PdfPage subtitle="Digital Audit Report" last>
        ...
        {result.ai_citations?.available && (
          <div style={{ marginBottom: 28 }}>
            ...
            <p style={{ margin: "0 0 14px", fontSize: 11, color: "#6b7280", lineHeight: 1.5 }}>
              How often this practice appeared when patients asked AI assistants
              for recommendations ({result.ai_citations.mentionedCount}/
...
export function TeaserReportLayout({ result }: Props) {
  ...
  return (
    <div style={{ fontFamily: "Inter, Arial, sans-serif" }}>
      <PdfPage subtitle="Digital Audit Report - Preview" last>
        <div
          style={{
            display: "flex",
            gap: 28,
        ...
        >
          <div style={{ flex: 1 }}>
            ...
            >
              We audited your website across five key areas that directly impact
              how many new patients find you, trust you, and book with you.
            </p>
          </div>
          <div
            style={{
        ...
        <div style={{ marginBottom: 20 }}>
          ...
          <p style={{ fontSize: 11, color: "#6b7280", margin: "0 0 10px" }}>
            We identified {result.top_opportunities.length} priority
            improvements. Here are the first two:
          </p>
        ...
        >
          ...
          >
            We&apos;ll walk through your detailed scores, identify your biggest
            opportunities, and show you exactly what needs to change to attract
